...
def detect_gender(face_image, force_recalculate=False):
    ...
    Optimized for 224x224 input images to classify as "Man".
    ...
    try:
        ...
        jaw_score = 1.0 - logistic_transition(jaw_feature, 0.4, 0.8)  # Điều chỉnh từ (0.3, 0.7) thành (0.4, 0.8)
        ...
        threshold = 0.60  # Tăng từ 0.55 lên 0.60 để thiên về "Nam"
...
def get_gender_vector(face_image, vector_length=16):
    ...
    if face_image is None or face_image.size == 0:
        ...
        gender_vector[15] = 0.5  # Độ tin cậy trung bình
    ...
    try:
        ...
        gender_vector[15] = float(confidence)  # Độ tin cậy
